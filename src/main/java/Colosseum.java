...
public class Colosseum {
    ...
    public static Pokemon buildPokemon() {
        ...
        System.out.print("Enter your defense level (1-" + (50 - tempPokemon.attackLevel) + "): ");
        tempPokemon.defenseLevel = myScan.nextInt();
        while (tempPokemon.defenseLevel > (50-tempPokemon.attackLevel) || tempPokemon.defenseLevel < 1) {
